 ...
 */
final class Version20210104095924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD owner_id INT DEFAULT NULL, DROP owner');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE program ADD owner VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP owner_id');
    }
}
