...
class __TwigTemplate_e27609b9fbf79bccf14c6231911e36a5d493375a5a7f35b29c7e863d1479f0d1 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"categories\">
            {% for category in categories %}
                <div class=\"category\">
                    ...
                    <a href=\"{{ path(\"category_show\", { categoryName: category.name }) }}\">
                        Voir les séries de cette catégorie
                    </a>
                </div>
