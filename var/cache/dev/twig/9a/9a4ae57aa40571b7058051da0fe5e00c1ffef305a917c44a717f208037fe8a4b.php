...
class __TwigTemplate_6ada289bf29eacf96c7871458bd34a740bc96d4ca5c3b3b2f42b66ba8fa35578 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("layout/base.html.twig", "episode/index.html.twig", 1);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["episode"]) {
            ...
            echo "            <tr>
                <th colspan=\"5\"class=\"title\">
                    ";
            // line 27
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["episode"], "season", [], "any", false, false, false, 27), "program", [], "any", false, false, false, 27), "title", [], "any", false, false, false, 27), "html", null, true);
            echo "
                </th>
            </tr>
            <tr>
                <td>";
            // line 31
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["episode"], "id", [], "any", false, false, false, 31), "html", null, true);
            echo "</td>
                <td class=\"title\">";
            // line 32
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["episode"], "title", [], "any", false, false, false, 32), "html", null, true);
            echo "</td>
                <td>";
            // line 33
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["episode"], "number", [], "any", false, false, false, 33), "html", null, true);
            echo "</td>
                <td>";
            // line 34
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["episode"], "synopsis", [], "any", false, false, false, 34), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 36
...
";
    ...
    {
        return array (  188 => 48,  183 => 45,  174 => 41,  165 => 37,  161 => 36,  156 => 34,  152 => 33,  148 => 32,  144 => 31,  137 => 27,  133 => 25,  128 => 24,  112 => 10,  102 => 9,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% endblock %}
", "episode/index.html.twig", "/home/christophe/Documents/Wild Code School/Quêtes Symfony/wild-series/templates/episode/index.html.twig");
    }
}
